    ...
    return (
       ...
       <Container className="py-5 mt-5">
            <Row className="justify-content-center mt-5">
                <Col xs={11} sm={10} md={8} lg={4} className={`p-4 rounded ${theme? 'text-light bg-dark border border-primary' : 'text-black bg-light border border-warning'} shadow`}>
                    ...
                    <Form onSubmit={handleSubmit}>
                        ...
                        <Button
                            type="submit"
                            className={`${theme? 'bg-light-black text-light' : 'bg-light-primary text-black'} m-auto d-block`}
                            disabled={loading}
                            style={{border: 0}}
                        >
                        {loading? 
                        ...
                        <Form.Group className="mt-3 text-center">
                            ...
                            <Link to='/register' className="btn bg-primary text-light rounded">
